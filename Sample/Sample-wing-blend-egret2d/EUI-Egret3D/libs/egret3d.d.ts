...
declare module egret3d {
    ...
    */
    ...
    class ParticleData {
        ...
        materialData: MaterialSphereData;
        /**
        * @language zh_CN
        * @version Egret 3.0
        * @platform Web,Native
    ...
    */
    class EgretMapXmlParser {
        ...
        */
        ...
        static parseMaterial(xml: Node): MaterialSphereData;
        private parseEnvironment(environment);
    }
}
declare module egret3d {
