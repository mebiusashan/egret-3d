...
* @platform Web,Native
*/
var SamplePointLight = (function (_super) {
    __extends(SamplePointLight, _super);
    function SamplePointLight() {
        ...
        */
        ...
        this.InitCameraCtl();
        ///创建点光源,设置灯光漫反射颜色
        var po = new egret3d.PointLight(0xffffff);
        ///设置光源位置
        po.y = 200;
        po.z = 200;
    ...
    var d = __define,c=SamplePointLight,p=c.prototype;
    /**
    * @language zh_CN
    * 窗口尺寸变化事件
    * @version Egret 3.0
...
egret.registerClass(SamplePointLight,'SamplePointLight');
//# sourceMappingURL=SamplePointLight.js.map