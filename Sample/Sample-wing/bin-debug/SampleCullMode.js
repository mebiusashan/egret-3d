 ...
 * @platform Web,Native
 */
var SampleCullMode = (function (_super) {
    __extends(SampleCullMode, _super);
    function SampleCullMode() {
        _super.call(this);
        ///创建Canvas对象。
    ...
    var d = __define,c=SampleCullMode,p=c.prototype;
    /**
    * @language zh_CN
    * 窗口尺寸变化事件
    * @version Egret 3.0
    ...
    */
    ...
    return SampleCullMode;
}(SampleBase));
egret.registerClass(SampleCullMode,'SampleCullMode');
//# sourceMappingURL=SampleCullMode.js.map