 ...
 * @platform Web,Native
 */
var SampleMultipleView3D = (function (_super) {
    __extends(SampleMultipleView3D, _super);
    function SampleMultipleView3D() {
        _super.call(this);
        this._cubeArray = new Array();
        ///创建Canvas对象。
    ...
    var d = __define,c=SampleMultipleView3D,p=c.prototype;
    p.update = function (e) {
        ///旋转
    ...
    return SampleMultipleView3D;
}(SampleBase));
egret.registerClass(SampleMultipleView3D,'SampleMultipleView3D');
//# sourceMappingURL=SampleMultipleView3D.js.map