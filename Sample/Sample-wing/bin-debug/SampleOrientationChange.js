 ...
 * @platform Web,Native
 */
var SampleOrientationChange = (function (_super) {
    __extends(SampleOrientationChange, _super);
    function SampleOrientationChange() {
        _super.call(this);
        ///创建Canvas对象。
    ...
    var d = __define,c=SampleOrientationChange,p=c.prototype;
    p.update = function (e) {
        ///旋转角度设置
    ...
    */
     ...
     * @platform Web,Native
     */
    SampleOrientationChange.speed = 0.2;
    return SampleOrientationChange;
}(SampleBase));
egret.registerClass(SampleOrientationChange,'SampleOrientationChange');
//# sourceMappingURL=SampleOrientationChange.js.map