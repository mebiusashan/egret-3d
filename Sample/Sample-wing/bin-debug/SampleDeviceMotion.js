...
* @platform Web,Native
*/
var SampleDeviceMotion = (function (_super) {
    __extends(SampleDeviceMotion, _super);
    function SampleDeviceMotion() {
        _super.call(this);
        /**
        * 动画播放控制器
        * @version Egret 3.0
    ...
    var d = __define,c=SampleDeviceMotion,p=c.prototype;
    p.update = function (e) {
        if (this.isPlaying) {
    ...
    */
    ...
    return SampleDeviceMotion;
}(SampleBase));
egret.registerClass(SampleDeviceMotion,'SampleDeviceMotion');
//# sourceMappingURL=SampleDeviceMotion.js.map