...
* @platform Web,Native
*/
var SampleUvRoll = (function (_super) {
    __extends(SampleUvRoll, _super);
    function SampleUvRoll() {
        _super.call(this);
        ///创建Canvas对象。
    ...
    var d = __define,c=SampleUvRoll,p=c.prototype;
    /**
    * @language zh_CN
    * 读取纹理回调
    * @version Egret 3.0
...
egret.registerClass(SampleUvRoll,'SampleUvRoll');
//# sourceMappingURL=SampleUvRoll.js.map